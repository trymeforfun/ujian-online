    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
          ...
          <div class="sidebar-brand-text mx-3">EXAM</div>
        </a>
            ...
            <li class="nav-item ">
              ...
              <div id="master" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  <a class="collapse-item" href="/users">Pengguna</a>
                  <a class="collapse-item" href="/lesson">Pelajaran</a>
                  <a class="collapse-item" href="/kelas">Kelas</a>
                  <a class="collapse-item" href="/student">Siswa</a>
                </div>
              </div>
            </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="buttons.html">Hasil Ujian</a>
              <a class="collapse-item" href="cards.html">Analysis Ujian</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseUtilitie" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="/assignment/create">Buat Ujian</a>
              <a class="collapse-item" href="/assignment">List Ujian</a>
              <a class="collapse-item" href="utilities-animation.html">Bank Soal</a>
            </div>
          </div>
        </li>
